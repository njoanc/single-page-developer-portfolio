...
function Skills() {
  ...
  return (
    <div className="bg-black font-space-grotesk text-center pt-[3rem] md:text-left md:px-5  lg:px-10 xl:px-10">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-7 md:gap-6 md:transform md:translate-y-[-29rem] lg:grid-cols-3 xl:grid-cols-3 lg:gap-3 xl:gap-3 xl:ranslate-y-[-25rem] xl:pl-[7rem] xl:translate-y-[-32rem]">
